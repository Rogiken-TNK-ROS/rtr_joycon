#ifndef RTR_JOYCON_MANI_JOG_CONTROL_H_
#define RTR_JOYCON_MANI_JOG_CONTROL_H_
...
namespace rtr
{
class ManiJogControl
{
 public:
  ManiJogControl(ros::NodeHandle& n);
...
#endif // RTR_JOYCON_MANI_JOG_CONTROL_H_
